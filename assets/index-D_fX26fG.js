...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(e,t,n){let r=new Float32Array(Ia),i=new J(0,1,0);return new hi({name:`SphericalGaussianBlur`,defines:{n:Ia,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(){return new hi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new hi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$a(),fragmentShader:`
	...
	`}var eo=class extends wt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new $r(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
void main() {
  ...
  `;let i=document.createElement(`div`);i.className=`overlay`,i.innerHTML=`
  ...
  `,n.appendChild(r),n.appendChild(i),e.appendChild(n);let a=r.querySelector(`#hud-time`),o=r.querySelector(`#stress-fill`),s=i.querySelector(`#panel-menu`),c=i.querySelector(`#panel-pause`),l=i.querySelector(`#panel-won`),u=i.querySelector(`#panel-lost`),d=i.querySelector(`#won-line`),f=new Set,p=`menu`,m=!1,h=t.phase,g=Jc(Zc);g?.samples?.length&&(t.showGhost(g.samples),m=!0);function _(){let e=p===`playing`&&t.phase===`playing`;i.classList.toggle(`hidden`,e),s.classList.toggle(`hidden`,p!==`menu`),c.classList.toggle(`hidden`,p!==`paused`),l.classList.toggle(`hidden`,t.phase!==`won`),u.classList.toggle(`hidden`,t.phase!==`lost`),r.style.opacity=e?`1`:`0.35`}function v(){t.hideGhost(),m=!1,t.startRun(),h=t.phase,p=`playing`,_(),t.renderer.domElement.focus(),t.renderer.domElement.requestPointerLock()}function y(){p=`menu`,t.goMenu(),t.hideGhost(),document.exitPointerLock();let e=Jc(Zc);e?.samples?.length&&(t.showGhost(e.samples),m=!0),_()}document.getElementById(`btn-start`).addEventListener(`click`,()=>v()),document.getElementById(`btn-resume`).addEventListener(`click`,()=>{p=`playing`,_(),t.renderer.domElement.focus(),t.renderer.domElement.requestPointerLock()}),document.getElementById(`btn-restart-p`).addEventListener(`click`,()=>v()),document.getElementById(`btn-title-p`).addEventListener(`click`,()=>y()),document.getElementById(`btn-again-w`).addEventListener(`click`,()=>v()),document.getElementById(`btn-title-w`).addEventListener(`click`,()=>y()),document.getElementById(`btn-again-l`).addEventListener(`click`,()=>v()),document.getElementById(`btn-title-l`).addEventListener(`click`,()=>y()),t.renderer.domElement.addEventListener(`click`,e=>{if(p!==`playing`||document.pointerLockElement!==t.renderer.domElement)return;let n=t.renderer.domElement.getBoundingClientRect(),r=(e.clientX-n.left)/n.width*2-1,i=-((e.clientY-n.top)/n.height)*2+1;t.tryGravityFromClick(r,i)});let b=new Set([`KeyW`,`KeyA`,`KeyS`,`KeyD`,`KeyE`,`KeyG`,`Space`,`ArrowUp`,`ArrowDown`,`ArrowLeft`,`ArrowRight`]);window.addEventListener(`keydown`,e=>{if(p===`playing`&&t.phase===`playing`&&b.has(e.code)&&document.pointerLockElement===t.renderer.domElement&&e.preventDefault(),f.add(e.code),e.code===`Escape`){p===`playing`&&t.phase===`playing`?(p=`paused`,_(),document.exitPointerLock()):p===`paused`&&(p=`playing`,_(),t.renderer.domElement.focus(),t.renderer.domElement.requestPointerLock());return}if(!e.repeat&&p===`playing`&&t.phase===`playing`&&e.code===`KeyG`){m=!m;let e=Jc(Zc);m&&e?.samples?.length?t.showGhost(e.samples):t.hideGhost()}}),window.addEventListener(`keyup`,e=>f.delete(e.code)),document.addEventListener(`pointerlockchange`,()=>{document.pointerLockElement!==t.renderer.domElement&&p===`playing`&&t.phase===`playing`&&(p=`paused`,_())}),document.addEventListener(`mousemove`,e=>{p!==`playing`||document.pointerLockElement!==t.renderer.domElement||t.addMouseLook(e.movementX,e.movementY)});let x=performance.now();function S(e){requestAnimationFrame(S);let n=Math.min(.05,Math.max(0,(e-x)/1e3));if(x=e,p===`playing`&&t.phase===`playing`){let e=f.has(`KeyW`)||f.has(`ArrowUp`),r=f.has(`KeyS`)||f.has(`ArrowDown`),i=f.has(`KeyA`)||f.has(`ArrowLeft`),s=f.has(`KeyD`)||f.has(`ArrowRight`),c=f.has(`Space`),l=f.has(`KeyE`);t.tick(n,e,r,i,s,c,l),a.textContent=t.timerActive&&t.hasPackage||t.hasPackage?Xc(t.runTime):`—`,o.style.width=`${Math.min(100,t.packageStress*100)}%`}else t.updateGhostPlayback(n);if(t.phase===`won`&&h!==`won`){Yc(Zc,t.getRecording(),t.runTime);let e=Jc(Zc);d.textContent=`Time ${Xc(t.runTime)}${e?.bestTimeSec==null?``:` · best ${Xc(e.bestTimeSec)}`}`,_(),document.exitPointerLock()}t.phase===`lost`&&h!==`lost`&&(_(),document.exitPointerLock()),h=t.phase,t.render()}requestAnimationFrame(S),window.addEventListener(`resize`,()=>{t.resize(window.innerWidth,window.innerHeight)}),_()}